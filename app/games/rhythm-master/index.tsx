...
const levels: Level[] = [
  {
    id: 1,
    title: 'Level 1',
    description: 'Simple rhythm patterns',
    difficulty: 'Easy',
    bpm: 90,
  },
  {
    id: 2,
    title: 'Level 2',
    description: 'Multiple lanes challenge',
    difficulty: 'Medium',
    bpm: 120,
  },
  {
...
export default function RhythmMasterLevels() {
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        {levels.map((level) => (
          <Pressable
            ...
            onPress={() => router.push(`/games/rhythm-master/${level.id}`)}
          >
              ...
              <View style={styles.badgeContainer}>
                ...
                {level.bpm && (
                  <View style={styles.bpmBadge}>
                    <Text style={styles.bpmText}>{level.bpm} BPM</Text>
                  </View>
                )}
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  difficultyBadge: { backgroundColor: '#e94560', paddingHorizontal: 12, paddingVertical: 4, borderRadius: 8 },
  difficultyText: { fontSize: 12, color: '#fff', fontWeight: '600' },
  bpmBadge: { backgroundColor: '#0f3460', borderWidth: 1, borderColor: '#e94560', paddingHorizontal: 12, paddingVertical: 4, borderRadius: 8 },
  bpmText: { fontSize: 12, color: '#e94560', fontWeight: '600' },
